...
S-Type (Circumstellar orbits) would technically still be a binary system, but the compagnion star is far away and both stars are not orbited together.
...
In case of binary systems it is possible a star  reaches its roche limity. In this case the star will exchange material with its neighbour via an accretion disk.
